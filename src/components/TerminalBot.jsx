...
const TerminalBot = () => {
  ...
  return (
    <div className="w-full h-[350px] bg-terminal-bg border border-neon-green rounded shadow-terminal flex flex-col relative bg-scanlines overflow-hidden mt-12 mx-auto">
